...
#set -x
#获取 token
ans=$(curl -s -X POST -H "Content-Type: application/json" -d '{  "app_key": "e3c963f2206644658920370fa54c5de5",  "app_secret": "44a42fd165674bb5bae5fa1bc6d965c2"}' "https://open.c.163.com/api/v1/token")
...
#echo "hub.c.163.com/xuxin1991/test:${image_tag2}"
...
if [ $status -eq 2 ];then
  echo $(curl -s -X POST -H "Authorization: Token ${token}" -H "Content-Type: application/json" -d '{
    ...
    "service_container_infos": [
        {
            "image_path": "hub.c.163.com/xuxin1991/test:'$image_tag2'",
